...
{
    public class TravelEscalationService : EscalationManagerBase
    {
        private readonly IEmployeeService _employeeService;
        private readonly IPermissionManager _permissionManager;

        public TravelEscalationService(IEmployeeService employeeService, IPermissionManager permissionManager)
        {
